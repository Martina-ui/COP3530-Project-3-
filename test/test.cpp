...
//     string output1 = buffer.str(); buffer.str(""); 

//     //invalid UFID 
//     compass.ParseCommand("insert \"Martina Delger\" 123 1 1 COP3530");
//     string output2 = buffer.str(); buffer.str(""); 

//     //Invalid class format
//     compass.ParseCommand("insert \"Martina Delger\" 12345678 1 1 cop3530");
//     string output3 = buffer.str(); buffer.str(""); 

//     //Too many classes
//     compass.ParseCommand("insert \"Martina Delger\" 12345678 1 7 COP3530 MAC2311 CDA3101 EEL3701 COP3502 COP3503 PHY2048");
//     string output4 = buffer.str(); buffer.str(""); 

//     //Duplicate UFID
//     compass.ParseCommand("insert \"Martina Delger\" 12345678 1 1 COP3530");
//     buffer.str(""); 
//     compass.ParseCommand("insert \"Martina Delger\" 12345678 1 1 MAC2311");
//     string output5 = buffer.str(); buffer.str(""); 
    
//     cout.rdbuf(old_cout);

//     REQUIRE(output1 == "unsuccessful\n");
//     REQUIRE(output2 == "unsuccessful\n");
//     REQUIRE(output3 == "unsuccessful\n");
//     REQUIRE(output4 == "unsuccessful\n");
//     REQUIRE(output5 == "unsuccessful\n");
// }
...
//     compass.ParseCommand("insert \"Martina Delger\" 12345678 1 1 COP3530");
//     string insert_out = buffer.str(); buffer.str(""); 

//     compass.ParseCommand("remove 12345678");
//     string first_remove_out = buffer.str(); buffer.str(""); 

//     compass.ParseCommand("remove 12345678");
//     string second_remove_out = buffer.str(); buffer.str(""); 

//     cout.rdbuf(old_cout);

//     REQUIRE(insert_out == "successful\n");
//     REQUIRE(first_remove_out == "successful\n");
//     REQUIRE(second_remove_out == "unsuccessful\n");
// }
